var highchartsUtils = function () {
    ...
    highchartsUtils.KPI = function() {
        ...
        var _generateKPI = function(){
            ...
            kpiDesc.each(function(index){
                ...
                if(type == 'square')
                {
                    ...
                    var chart = new highchartsUtils.KPI.SquareZone();
                ...
                else if(type == 'line')
                {
                    ...
                    var chartL = new highchartsUtils.KPI.Chart();
                    var chartP = new highchartsUtils.KPI.Chart();
        ...
        highchartsUtils.KPI.Chart = function () {
        ...
        highchartsUtils.KPI.SquareZone = function () {
            ...
            return {
                ...
                initArrow: function (id, request) {
                    ...
                    _request = request;
                    _bindEvents();
                    _UpdateWithNextsCommunity(request,1,10);_
                },
